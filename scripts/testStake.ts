...
async function main(){
  const deployedStakeAddress = "0x40a42Baf86Fc821f972Ad2aC878729063CeEF403";
...
// const approve = ERC20.connect(signer).approve(deployedStakeAddress,1000000)
...
// console.log(allowance);
    ...
    //  await deployedStake.connect(signer).stakeToken(1000)

    //  console.log("YOUR BALANCE AFTER",await ERC20.balanceOf(BOREDAPEOWNER))



// const Stake = await deployedStake.stakeToken(
//   100
// )
...
await deployedStake.withdraw(300);
